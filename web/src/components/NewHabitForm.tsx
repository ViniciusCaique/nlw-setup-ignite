...
const availableWeekDays = [ 'Domingo', 'Segunda-Feira', 'Terça-Feira', 'Quinta-Feira', 'Sexta-Feira', 'Sábado']
        ...
        <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
            ...
            {availableWeekDays.map((weekDay, i)=> {
                return(
                    ...
                    >
                        <div className='h-8 w-8 rounded-lg flex items-center justify-center bg-zinc-900 border-2 border-zinc-800 group-data-[state=checked]:bg-green-500 group-data-[state=checked]:bg-border-500 transition-colors group-focus:ring-2 group-focus:ring-violet-700 group-focus:ring-offset-2 group-focus:ring-offset-background'>
                            <Checkbox.Indicator>
